...
export default function FloatingAIAssistant() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Glow behind robot */}
        <div className="absolute inset-0 bg-blue-500/30 blur-2xl rounded-full mix-blend-screen scale-150 group-hover:bg-blue-400/40 transition-colors duration-500"></div>
        ...
        >
          <Sparkles className="absolute top-0 right-2 w-3 h-3 text-blue-300 animate-pulse" />
          <Sparkles className="absolute bottom-4 left-0 w-2 h-2 text-purple-300 animate-ping" style={{ animationDuration: '3s' }} />
        </motion.div>

        {/* Head */}
        <motion.div 
          className="relative w-16 h-14 rounded-full bg-gradient-to-b from-blue-100 to-blue-300 shadow-[inset_0_-4px_10px_rgba(0,0,0,0.2),0_10px_15px_-3px_rgba(0,0,0,0.3)] z-10 flex items-center justify-center overflow-hidden"
          ...
          <div className="w-12 h-7 bg-[#0B0B0B] rounded-full relative shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)] overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center gap-2">
              <motion.div 
                ...
                className="w-2 h-3 bg-blue-400 rounded-full shadow-[0_0_8px_rgba(96,165,250,0.8)]"
              ></motion.div>
              <motion.div 
                animate={{ scaleY: isBlinking ? 0.1 : 1 }}
                className="w-2 h-3 bg-blue-400 rounded-full shadow-[0_0_8px_rgba(96,165,250,0.8)]"
        ...
        {/* Neck connector */}
        <div className="w-4 h-2 bg-blue-400/80 -mt-1 z-0 shadow-inner"></div>

        {/* Body */}
        <div className="relative w-14 h-16 bg-gradient-to-b from-blue-200 to-blue-400 rounded-[2rem] shadow-[inset_0_-5px_15px_rgba(0,0,0,0.2),0_15px_20px_-5px_rgba(0,0,0,0.4)] z-10 flex flex-col items-center justify-start pt-3">
          {/* Chest details */}
          ...
          <motion.div 
            ...
            className="absolute top-2 -left-4 w-3.5 h-10 bg-gradient-to-b from-blue-200 to-blue-400 rounded-full shadow-md z-0"
          ></motion.div>

          {/* Right Arm */}
          <motion.div 
            animate={{ rotate: -10 }}
            className="absolute top-2 -right-4 w-3.5 h-10 bg-gradient-to-b from-blue-200 to-blue-400 rounded-full shadow-md z-0"
          ></motion.div>
        </div>
        ...
        <div className="w-8 h-3 bg-gray-800 rounded-b-full -mt-2 z-0 relative flex justify-center shadow-[0_5px_15px_rgba(0,0,0,0.5)]">
          ...
          <motion.div 
            ...
            style={{ originY: 0 }}
            className="w-4 h-6 bg-gradient-to-b from-cyan-400 via-blue-500 to-transparent rounded-b-full absolute top-full blur-[2px]"
          ></motion.div>
        </div>
